  ...
  return (
    <div className="flex flex-col gap-6">
      <div className="grid w-full mx-auto grid-cols-1 sm:grid-cols-2 gap-6">
        ...
        <Card className="w-full mx-auto max-w-xs">
          <p className="text-tremor-default text-dark-tremor-content flex gap-1 items-center">
            Today&apos;s visitors
            <Badge
              percentage={
      ...
      <Card className="flex flex-col sm:grid grid-cols-4 gap-6">
        <h2 className="w-full text-dark-tremor-content-strong text-center sm:left-0 font-semibold text-xl">
        ...
        <div className="col-span-3 flex items-center justify-between flex-wrap gap-8">
          {topCountries?.map(([countryCode, count]) => {
            return (
              <div
                key={countryCode}
                className="flex items-center gap-3 to-dark-tremor-content-strong"
              >
                <p className="hidden sm:block to-tremor-content">
                  {countryCode}
                </p>
                <ReactCountryFlag
                  ...
                  svg
                />
                <p className="text-tremor-content sm:to-dark-tremor-content-strong">
                  {count}
                </p>
              </div>
            );
